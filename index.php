...
<body>
    ...
    <section id="home" class="hero-section">
        <div class="hero-content">
            ...
            <a href="recomendation.php" class="btn btn-custom">Get Recommendations</a>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4" data-aos="fade-up">
                    <div class="step-card">
                        ...
                        <p>Sign up and tell us about your style preferences</p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="step-card">
                        ...
                        <p>Receive personalized fashion suggestions</p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="step-card">
                        ...
                        <h3>Shop & Style</h3>
                        <p>Find items at nearby boutiques or online</p>
                    </div>
                </div>
            </div>
        </div>
